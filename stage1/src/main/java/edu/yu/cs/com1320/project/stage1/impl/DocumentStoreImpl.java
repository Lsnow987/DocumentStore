...
public class DocumentStoreImpl implements DocumentStore{
   ...
   // };
    ...
    public int putDocument(InputStream input, URI uri, DocumentFormat format) throws IOException{
        ...
        if ( uri == null || uri.equals(uriEmpty) || format == null ) {
        ...
        putDocumentCommand(uri, previousValue, format);
    ...
    private void putDocumentCommand(URI uri, Document previousValue, DocumentFormat format){
    ...
    public void undo(URI uri) throws IllegalStateException{ 
        ...
        while(!c.getUri().equals(uri) /*&& stackImplementation.peek()!=null*/) {
            ...
            if(stackImplementation.peek()!=null){
