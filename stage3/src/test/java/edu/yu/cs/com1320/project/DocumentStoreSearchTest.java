...
public class DocumentStoreSearchTest {
    ...
    public void basicSearchAndOrganizationTest() throws IOException {
        ...
        for (String s:store.searchByPrefix("p").get(0).getWords()) {
            System.out.println(s + "          SSSSSSSSSSSSSSSSSSSSSSSSS!!!!!!!!!!!!!!!!!!!!");
        }
        System.out.println(store.searchByPrefix("p").get(0).getWords().size() + "      1111111111");
        for (String s:store.searchByPrefix("p").get(1).getWords()) {
            System.out.println(s + "           222222222222222222222222");
        }
        System.out.println(store.searchByPrefix("p").get(1).getWords().size() + "      2222222222");
        for (String s:store.searchByPrefix("p").get(2).getWords()) {
            System.out.println(s + "           333333333333333333333333");
        }
        System.out.println(store.searchByPrefix("p").get(2).getWords().size() + "      333333333333");
