...
class Test2 {
	 ...
	 void testPutDocumentStoreAsText() {
	  ...
	  try {
	   documentStore.putDocument(inputStream1, uri1, DocumentStore.DocumentFormat.TXT);
		  //System.out.println(documentStore.getDocument(uri1).getDocumentTxt()+ "  aaaaaaaa");
	  ...
	  Document document1 = (Document) new DocumentImpl(uri1, string1);
	  Document document2 = (Document) new DocumentImpl(uri2, string2);
	  Document document3 = (Document) new DocumentImpl(uri3, string3);
	  Document document4 = (Document) new DocumentImpl(uri4, string4);
	  ...
	  //System.out.println(documentStore.getDocument(uri1)+ "  AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA    " + document1);
	  //System.out.println(documentStore.getDocument(uri1).getDocumentTxt() + "  aaaaaaaaaaaaa " + documentStore.getDocument(uri1).getKey());
	 ...
	 void testGetAndPutReturnValues() {
	  ...
	  for (int i = 0; i < 7; i++) {
	   docArray[i] = (Document) new DocumentImpl(uriArray[i], stringArray[i]);
	  }
	  for (int i = 0; i < 7; i++) {
	   docArray[i+7] = (Document) new DocumentImpl(uriArray[i], stringArray[i+7].getBytes());
	  }
	  for (int i = 0; i < 7; i++) {
	   docArray[i+14] = (Document) new DocumentImpl(uriArray[i], stringArray[i+14]);
	  }
	 DocumentStore documentStore = new DocumentStoreImpl();
	 try {
	...
	@Test
	  public void docTest() throws URISyntaxException {
	    ...
	    byte[] b1 = { 1, 2, 4, 56, 7, 7, 6, 5, 43, 4, 6, 7, 8, 8, 8, 55, 52, 5, 2, 52, 75, 95, 25, 85, 74, 52, 52, 5, 67,
	        61 };
	    Document doc1 = (Document) new DocumentImpl(me1, s1);
	    Document doc2 = (Document) new DocumentImpl(me2, b1);
	    ...
	    void addNewToStore() throws URISyntaxException, IOException {
	        ...
	        Document doc = (Document) new DocumentImpl(uri, stream2.readAllBytes());
	    ...
	    void TestDeleteDocument() throws URISyntaxException, IOException {
	        ...
	        Document doc2 = (Document) new DocumentImpl(uri, stream4.readAllBytes());
	        assertEquals(doc2, store.getDocument(uri));
...
public void testCollisionPutValues() throws IOException {
    ...
    Document document1 = (Document) new DocumentImpl(uri1, string1.getBytes());
    Document document2 = (Document) new DocumentImpl(uri2, string2.getBytes());
    Document document3 = (Document) new DocumentImpl(uri3, string3);
    Document document4 = (Document) new DocumentImpl(uri4, string4);
  ...
  */
  ...
  public void DocumentImplGetKeyTest() throws URISyntaxException {
	  ...
	  Document document = (Document) new DocumentImpl(uri, str);
  ...
  public void DocumentImplgetDocumentBinaryData() throws URISyntaxException {
	  ...
	  String str = "heeelllllllllllllllllooooooooo";
	  byte[] myVar = "Any String you want".getBytes();
	  Document documentStrings = (Document) new DocumentImpl(uri, str);
	  Document documentBytes = (Document) new DocumentImpl(uri, myVar);
  ...
  public void DocumentImplEquals() throws URISyntaxException {
	  ...
	  byte[] myVar = "Any String you want".getBytes();
	  Document documentStrings = (Document) new DocumentImpl(uri, str);
	  Document documentStrings2 = (Document) new DocumentImpl(uri, str);
	  Document documentBytes = (Document) new DocumentImpl(uri, myVar);
...
@Test
    void testStackUndo() throws IOException, URISyntaxException {
        ...
        Document doc = (Document) new DocumentImpl(uri1, stream11.readAllBytes());
    ...
    void testStackUndoUri() throws IOException, URISyntaxException {
        ...
        Document doc2 = (Document) new DocumentImpl(uri2, stream22.readAllBytes());
    ...
    void testStackUriPutOverwrite() throws IOException, URISyntaxException {
        ...
        Document doc = (Document) new DocumentImpl(uri, stream11.readAllBytes());
        assertEquals(doc, store.getDocument(uri));
        ...
        assertEquals(doc.hashCode(), store.putDocument(stream2, uri, DocumentFormat.BINARY));
        Document doc2 = (Document) new DocumentImpl(uri, stream22.readAllBytes());
        assertEquals(doc2, store.getDocument(uri));
        store.undo();
    ...
    void testStackUriDeleteOverwrite() throws IOException, URISyntaxException {
        ...
        Document doc3 = (Document) new DocumentImpl(uri, stream33.readAllBytes());
    ...
    void testStackUriDeleteOverwriteMultipleDocs() throws IOException, URISyntaxException {
        ...
        Document doc3 = (Document) new DocumentImpl(uri2, stream33.readAllBytes());
